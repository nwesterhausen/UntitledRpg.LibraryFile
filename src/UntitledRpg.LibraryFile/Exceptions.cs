...
public class UrpglibFileFormatException : Exception
{
	...
	///     The exception that caused the current exception, or <see langword="null" /> if no inner
...
{
	/// <summary>
	///     Represents an exception that is thrown when there is a version mismatch in the URPG schema versions between the
