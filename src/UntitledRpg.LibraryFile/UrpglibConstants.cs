...
public static class UrpglibConstants
{
	...
	/// </summary>
	/// <remarks>
	///     The default options use camel case for property naming and do not write indented JSON. These
	///     settings are commonly used for consistent and compact JSON serialization.
	/// </remarks>
